...
<div class="flex flex-col w-full">
    <section class="px-10 pt-12 pb-8">
        <div class="flex items-baseline gap-4 mb-4">
            <span class="text-[14px] text-[#979799] uppercase tracking-[0.2em]">Anggota Baru</span>
            <div class="h-px flex-1 bg-[#f2f2f3]"></div>
        </div>
        <h1 class="font-serif-display text-[64px] leading-[1.3] tracking-[-0.96px] text-[#17191c]">Tambah Anggota</h1>
    </section>
